...
@Entity
@Table(name = "ishika_customer_master_6")
public class CustomerMaster {
    ...
    public CustomerMaster(Integer customerId, String customerCode, String customerName, String customerAddress1,
    ...
    public CustomerMaster(CustomerMaster customerMaster) {
        this.customerId = customerMaster.customerId;
        this.customerCode = customerMaster.customerCode;
        this.customerName = customerMaster.customerName;
        this.customerAddress1 = customerMaster.customerAddress1;
        this.customerAddress2 = customerMaster.customerAddress2;
        this.customerPincode = customerMaster.customerPincode;
        this.customerEmail = customerMaster.customerEmail;
        this.contactNumber = customerMaster.contactNumber;
        this.primaryContactPerson = customerMaster.primaryContactPerson;
        this.recordStatus = customerMaster.recordStatus;
        this.activeInactiveFlag = customerMaster.activeInactiveFlag;
        this.createDate = customerMaster.createDate;
        this.createdBy = customerMaster.createdBy;
        this.modifiedDate = customerMaster.modifiedDate;
        this.modifiedBy = customerMaster.modifiedBy;
        this.authorizedDate = customerMaster.authorizedDate;
        this.authorizedBy = customerMaster.authorizedBy;
    }
